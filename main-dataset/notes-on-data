...
## impact statement
Text of the paper’s broader impact statement scraped from the XML database using the code on this github repository.

## impact title
Title of the paper’s broader impact statement scraped from the XML database using the code on this github repository.

## word count
The word count of the text of the broader impact statement.

## sentence count
The sentence count of the text of the broader impact statement, obtained using the NLTK package and corrected for miscounts (“e.g. ” and “i.e. ”) using this code.
